...
//         let delegated_witness = witness::from_witness<SUITRADERS, Witness>(Witness {});

//         let mint_cap = mint_cap::new_from_delegated<, SUITRADERS>(
//                 delegated_witness,
//                 &collection,
//                 option::none(),
//                 ctx
...
//         royalty_strategy_bps::create_domain_and_add_strategy<SUITRADERS>(

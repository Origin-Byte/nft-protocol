#[test_only]
module nft_protocol::test_bidding {
    use nft_protocol::nft;
    use nft_protocol::collection::{Self, Collection};
    use nft_protocol::bidding::{Self, Bid};
    ...
    fun it_works() {
        ...
        let buyer_owner_cap = safe::create_safe(ctx(&mut scenario));
        ...
        let transfer_cap = test_scenario::take_shared<Bid<SUI>>(&mut scenario);

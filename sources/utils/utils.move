...
module nft_protocol::utils {
    ...
    public fun assert_not_nft_protocol_type<T>() {
        ...
        assert!(t_pkg != package_id(), err::generic_nft_must_not_be_protocol_type());
    }

    /// Returns true if T is of type `nft_protocol::Nft`
    public fun is_protocol_nft_type<T>(): bool {

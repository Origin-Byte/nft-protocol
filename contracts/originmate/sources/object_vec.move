...
/// @title object_vec
/// @dev An implementation ObjectTable that does not require a generic for key
/// and it uses indexing.
module originmate::object_vec {
...
/// @dev Attempted to destroy a non-empty table
const ETableNotEmpty: u64 = 0x80008;

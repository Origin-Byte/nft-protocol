...
module ob_authlist::test_authlist {
    ...
    #[test]
    #[expected_failure(abort_code = ob_authlist::authlist::EInvalidAdmin)]
    ...
    #[test]
    #[expected_failure(abort_code = ob_authlist::authlist::EInvalidAuthority)]
    ...
    #[test]
    #[expected_failure(abort_code = ob_authlist::authlist::EInvalidCollection)]

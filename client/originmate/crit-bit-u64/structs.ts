...
export class CB<V extends TypeArgument> {
    ...
    private constructor(typeArg: string, fields: CBFields<V>,
        ...
        typeArg) as `0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::crit_bit_u64::CB<${ToTypeStr<V>}>`;
    ...
    toJSONField() {
        return {
            r: this.r.toString(),i: fieldToJSON<Vector<I>>(`vector<0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::crit_bit_u64::I>`, this.i),o: fieldToJSON<Vector<O<V>>>(`vector<0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::crit_bit_u64::O<${this.$typeArg}>>`, this.o),
...
export class O<V extends TypeArgument> {
    ...
    private constructor(typeArg: string, fields: OFields<V>,
        ...
        typeArg) as `0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::crit_bit_u64::O<${ToTypeStr<V>}>`;

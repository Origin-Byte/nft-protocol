...
export function isClawbackCapability(type: string): boolean {
    ...
    return type === "0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::linear_vesting::ClawbackCapability";
}
...
export function isWallet(type: string): boolean {
    type = compressSuiType(type);
    return type.startsWith("0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::linear_vesting::Wallet<");
}

export interface WalletFields<T extends PhantomTypeArgument> {
    id: ToField<UID>; beneficiary: ToField<"address">; coin: ToField<Coin<T>>; released: ToField<"u64">; start: ToField<"u64">; duration: ToField<"u64">
}
...
export class Wallet<T extends PhantomTypeArgument> implements StructClass {
    ...
    static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Wallet.reified(
            ...
            {id: decodeFromFields(UID.reified(), fields.id), beneficiary: decodeFromFields("address", fields.beneficiary), coin: decodeFromFields(Coin.reified(typeArg), fields.coin), released: decodeFromFields("u64", fields.released), start: decodeFromFields("u64", fields.start), duration: decodeFromFields("u64", fields.duration)}
        )
    }
    ...
    static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Wallet.reified(
            ...
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), beneficiary: decodeFromFieldsWithTypes("address", item.fields.beneficiary), coin: decodeFromFieldsWithTypes(Coin.reified(typeArg), item.fields.coin), released: decodeFromFieldsWithTypes("u64", item.fields.released), start: decodeFromFieldsWithTypes("u64", item.fields.start), duration: decodeFromFieldsWithTypes("u64", item.fields.duration)}
        )
    }
    ...
    static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Wallet.reified(
            ...
            {id: decodeFromJSONField(UID.reified(), field.id), beneficiary: decodeFromJSONField("address", field.beneficiary), coin: decodeFromJSONField(Coin.reified(typeArg), field.coin), released: decodeFromJSONField("u64", field.released), start: decodeFromJSONField("u64", field.start), duration: decodeFromJSONField("u64", field.duration)}
        )
    }

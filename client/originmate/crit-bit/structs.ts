...
export function isCB(type: string): boolean {
    ...
    return type.startsWith("0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::crit_bit::CB<");
}
...
export function isI(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::crit_bit::I";
}
...
export function isO(type: string): boolean {
    type = compressSuiType(type);
    return type.startsWith("0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::crit_bit::O<");
}

export interface OFields<V extends TypeArgument> {
    k: ToField<"u128">; v: ToField<V>; p: ToField<"u64">
}
...
export class O<V extends TypeArgument> implements StructClass {
    ...
    static fromFields<V extends Reified<TypeArgument, any>>(
        ...
        return O.reified(
            ...
            {k: decodeFromFields("u128", fields.k), v: decodeFromFields(typeArg, fields.v), p: decodeFromFields("u64", fields.p)}
        )
    }
    ...
    static fromFieldsWithTypes<V extends Reified<TypeArgument, any>>(
        ...
        return O.reified(
            ...
            {k: decodeFromFieldsWithTypes("u128", item.fields.k), v: decodeFromFieldsWithTypes(typeArg, item.fields.v), p: decodeFromFieldsWithTypes("u64", item.fields.p)}
        )
    }
    ...
    static fromJSONField<V extends Reified<TypeArgument, any>>(
        ...
        return O.reified(
            ...
            {k: decodeFromJSONField("u128", field.k), v: decodeFromJSONField(typeArg, field.v), p: decodeFromJSONField("u64", field.p)}
        )
    }

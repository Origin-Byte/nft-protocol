...
export function isFROZEN_PUB(type: string): boolean {
    ...
    return type === "0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::frozen_pub::FROZEN_PUB";
}
...
export class FROZEN_PUB implements StructClass {
    static readonly $typeName = "0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::frozen_pub::FROZEN_PUB";
    static readonly $numTypeParams = 0;

    readonly $typeName = FROZEN_PUB.$typeName;

    readonly $fullTypeName: "0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::frozen_pub::FROZEN_PUB";
    ...
    private constructor(typeArgs: [], fields: FROZEN_PUBFields,
        ...
        this.$fullTypeName = composeSuiType(
            FROZEN_PUB.$typeName,
            ...typeArgs
        ) as "0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::frozen_pub::FROZEN_PUB";
